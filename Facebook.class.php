...
class API_Facebook {
	...
	public static function getLoginUrl($register_url, $permissions = array('public_profile','email')) {

		$fb = new Facebook\Facebook(array(
			'app_id' => self::FACEBOOK_APP_ID,
  			'app_secret' => self::FACEBOOK_SECRET_KEY,
  			'default_graph_version' => 'v2.5',
  		));

		$helper = $fb->getRedirectLoginHelper();

		$loginUrl = $helper->getLoginUrl($register_url, $permissions);
